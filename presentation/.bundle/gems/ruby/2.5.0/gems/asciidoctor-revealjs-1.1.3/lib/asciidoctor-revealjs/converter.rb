...
class Asciidoctor::Revealjs::Converter < ::Asciidoctor::Converter::Base
  ...
  def toc(node, opts = {})
    ...
    node.instance_eval do
      ...
      ; 
      ; 
      ; _buf << ("<div id=\"toc\"".freeze); _temple_html_attributeremover1 = ''; _slim_codeattributes1 = (attr 'toc-class', 'toc'); if Array === _slim_codeattributes1; _slim_codeattributes1 = _slim_codeattributes1.flatten; _slim_codeattributes1.map!(&:to_s); _slim_codeattributes1.reject!(&:empty?); _temple_html_attributeremover1 << ((_slim_codeattributes1.join(" ")).to_s); else; _temple_html_attributeremover1 << ((_slim_codeattributes1).to_s); end; _temple_html_attributeremover1; if !_temple_html_attributeremover1.empty?; _buf << (" class=\"".freeze); _buf << ((_temple_html_attributeremover1).to_s); _buf << ("\"".freeze); end; _buf << ("><div id=\"toctitle\">".freeze); 
  ...
  def document(node, opts = {})
    ...
    node.instance_eval do
      ...
      ; end; case attr 'source-highlighter'; 
      ; when 'coderay'; 
      ...
      ; _buf << ((revealjsdir).to_s); _buf << ("/js/reveal.js\"></script><script>// See https://github.com/hakimel/reveal.js#configuration for a full list of configuration options\nReveal.initialize({\n  // Display controls in the bottom right corner\n  controls: ".freeze); 
      ; 
      ; 
      ; 
      ; 
      ...
      ; 
      ; _buf << ((attr 'revealjs_defaultTiming', 'null').to_s); _buf << (",\n  // Display the page number of the current slide\n  slideNumber: ".freeze); 
      ; 
      ; _buf << ((to_boolean(attr 'revealjs_slidenumber', false)).to_s); _buf << (",\n  // Push each slide change to the browser history\n  history: ".freeze); 
      ; 
      ...
      ; _buf << ((revealjsdir).to_s); _buf << ("/plugin/markdown/marked.js', condition: function() { return !!document.querySelector( '[data-markdown]' ); } },\n      { src: '".freeze); 
      ; _buf << ((revealjsdir).to_s); _buf << ("/plugin/markdown/markdown.js', condition: function() { return !!document.querySelector( '[data-markdown]' ); } },\n      ".freeze); 
      ...
      ; _buf << ("\n      { src: '".freeze); _buf << ((revealjsdir).to_s); _buf << ("/plugin/zoom-js/zoom.js', async: true },\n      { src: '".freeze); 
      ; _buf << ((revealjsdir).to_s); _buf << ("/plugin/notes/notes.js', async: true }\n  ]\n});</script>".freeze); 
      ; 
      ; 
  ...
  def listing(node, opts = {})
    ...
    node.instance_eval do
      converter.set_local_variables(binding, opts) unless opts.empty?
      _buf = ''; _buf << ("<div".freeze); _temple_html_attributeremover1 = ''; _temple_html_attributemerger1 = []; _temple_html_attributemerger1[0] = "listingblock"; _temple_html_attributemerger1[1] = ''; _slim_codeattributes1 = role; if Array === _slim_codeattributes1; _slim_codeattributes1 = _slim_codeattributes1.flatten; _slim_codeattributes1.map!(&:to_s); _slim_codeattributes1.reject!(&:empty?); _temple_html_attributemerger1[1] << ((_slim_codeattributes1.join(" ")).to_s); else; _temple_html_attributemerger1[1] << ((_slim_codeattributes1).to_s); end; _temple_html_attributemerger1[1]; _temple_html_attributeremover1 << ((_temple_html_attributemerger1.reject(&:empty?).join(" ")).to_s); _temple_html_attributeremover1; if !_temple_html_attributeremover1.empty?; _buf << (" class=\"".freeze); _buf << ((_temple_html_attributeremover1).to_s); _buf << ("\"".freeze); end; _slim_codeattributes2 = @id; if _slim_codeattributes2; if _slim_codeattributes2 == true; _buf << (" id".freeze); else; _buf << (" id=\"".freeze); _buf << ((_slim_codeattributes2).to_s); _buf << ("\"".freeze); end; end; _buf << (">".freeze); 
      ; if title?; 
      ; _buf << ("<div class=\"title\">".freeze); _buf << ((captioned_title).to_s); 
      ; _buf << ("</div>".freeze); end; _buf << ("<div class=\"content\">".freeze); 
      ...
      ; _buf << ("<pre".freeze); _temple_html_attributeremover2 = ''; _slim_codeattributes3 = pre_class; if Array === _slim_codeattributes3; _slim_codeattributes3 = _slim_codeattributes3.flatten; _slim_codeattributes3.map!(&:to_s); _slim_codeattributes3.reject!(&:empty?); _temple_html_attributeremover2 << ((_slim_codeattributes3.join(" ")).to_s); else; _temple_html_attributeremover2 << ((_slim_codeattributes3).to_s); end; _temple_html_attributeremover2; if !_temple_html_attributeremover2.empty?; _buf << (" class=\"".freeze); _buf << ((_temple_html_attributeremover2).to_s); _buf << ("\"".freeze); end; _slim_codeattributes4 = pre_lang; if _slim_codeattributes4; if _slim_codeattributes4 == true; _buf << (" lang".freeze); else; _buf << (" lang=\"".freeze); _buf << ((_slim_codeattributes4).to_s); _buf << ("\"".freeze); end; end; _buf << ("><code".freeze); 
      ; _slim_codeattributes5 = code_noescape; if _slim_codeattributes5; if _slim_codeattributes5 == true; _buf << (" data-noescape".freeze); else; _buf << (" data-noescape=\"".freeze); _buf << ((_slim_codeattributes5).to_s); _buf << ("\"".freeze); end; end; _temple_html_attributeremover3 = ''; _slim_codeattributes6 = code_class; if Array === _slim_codeattributes6; _slim_codeattributes6 = _slim_codeattributes6.flatten; _slim_codeattributes6.map!(&:to_s); _slim_codeattributes6.reject!(&:empty?); _temple_html_attributeremover3 << ((_slim_codeattributes6.join(" ")).to_s); else; _temple_html_attributeremover3 << ((_slim_codeattributes6).to_s); end; _temple_html_attributeremover3; if !_temple_html_attributeremover3.empty?; _buf << (" class=\"".freeze); _buf << ((_temple_html_attributeremover3).to_s); _buf << ("\"".freeze); end; _buf << (">".freeze); _buf << ((content).to_s); 
      ; _buf << ("</code></pre>".freeze); else; 
      ; _buf << ("<pre".freeze); _temple_html_attributeremover4 = ''; _slim_codeattributes7 = (nowrap ? 'nowrap' : nil); if Array === _slim_codeattributes7; _slim_codeattributes7 = _slim_codeattributes7.flatten; _slim_codeattributes7.map!(&:to_s); _slim_codeattributes7.reject!(&:empty?); _temple_html_attributeremover4 << ((_slim_codeattributes7.join(" ")).to_s); else; _temple_html_attributeremover4 << ((_slim_codeattributes7).to_s); end; _temple_html_attributeremover4; if !_temple_html_attributeremover4.empty?; _buf << (" class=\"".freeze); _buf << ((_temple_html_attributeremover4).to_s); _buf << ("\"".freeze); end; _buf << (">".freeze); _buf << ((content).to_s); 
      ; _buf << ("</pre>".freeze); end; _buf << ("</div></div>".freeze); _buf
    end
  end
  ...
  def admonition(node, opts = {})
    ...
    node.instance_eval do
      converter.set_local_variables(binding, opts) unless opts.empty?
      _buf = ''; if (has_role? 'aside') or (has_role? 'speaker'); 
